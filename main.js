...
function sendData2GoogleSheet(data){
    ...
    for (var i=0; i<finaldata["round"].length;i++){
        ...
        data4json.push({ "User":info_data["username"], "ParticipantID":info_data["id"], "Participant_Type":info_data["type"], "Scrolling_Technique":info_data["tech"], "Level_of_Experience":info_data["exp"].split("=")[0], 
